...
class Products{
    ...
    function insertProduct(){
        ...
        VALUES (:p_cat_id, :cat_id, :dateNow, :product_title, :img_1, :img_2, :img_3, :price, :keywords, :product_desc)");
    
        $this->conn->bind(":p_cat_id",$this->p_cat_id);
        $this->conn->bind(":cat_id",$this->cat_id);
        $this->conn->bind(":dateNow",$this->date);
        $this->conn->bind(":img1",$this->product_img1);
        $this->conn->bind(":img2",$this->product_img2);
        $this->conn->bind(":img3",$this->product_img3);
        $this->conn->bind(":price",$this->product_price);
        $this->conn->bind(":keywords",$this->product_keywords);
