...
<?php 
  ...
  if(isset($_GET['pro_id'])){
    ...
    // $get_product_id = new Products();
    // $product = $get_product_id->getProductByID($product_id);

    $get_product_id = "SELECT * from products where product_id = '$product_id'";
    $product = $pdo->query($get_product_id)->fetch();
    ...
    $row_p_cat = $pdo->query($get_p_cat)->fetch();
    $p_cat_title = $row_p_cat['p_cat_title'];

    // $get_p_cat = new ProductCategory();
    // $row_p_cat = $get_p_cat->getProdCategoryById($product_cat_id);
    // $p_cat_title = $row_p_cat['p_cat_title'];
