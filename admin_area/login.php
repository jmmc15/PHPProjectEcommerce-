...
<head>
    ...
    <title>Clothing Store Admin Area</title>
...
<?php 
    ...
    if(isset($_POST['admin_login'])){
        ...
        $run_admin = $pdo->query($get_admin);
        
        while($row_admin = $run_admin->fetch()){
            $hashedPwd = $row_admin["admin_pass"];
        }

        $checkPwd = password_verify($admin_pass, $hashedPwd);
