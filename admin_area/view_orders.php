                    ...
                    <table class="table table-striped table-bordered table-hover"><!-- table table-striped table-bordered table-hover begin -->
                        ...
                        <tbody><!-- tbody begin -->
                            ...
                            <?php 
                                ...
                                $run_orders = $pdo->query($get_orders);
          
                                while($row_order=$run_orders->fetch()){
                                    ...
                                    $row_products = $pdo->query($get_products)->fetch();
                                    
                                    $product_title = $row_products['product_title'];
                                    
                                    $get_customer = "select * from customers where customer_id='$c_id'";
                                    
                                    $row_customer = $pdo->query($get_customer)->fetch();
                                    
                                    $customer_email = $row_customer['customer_email'];
                                    
                                    $get_c_order = "select * from customer_orders where order_id='$order_id'";
                                    
                                    $row_c_order = $pdo->query($get_c_order)->fetch();
